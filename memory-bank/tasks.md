...
- [ ] Шаг 1.1: Добавить импорт `afterEach` в `src/utils/storage.test.ts`
- [ ] Шаг 1.2: Добавить `afterEach` hook в `src/utils/storage.test.ts`
- [ ] Шаг 1.3: Удалить `spy.mockRestore()` из `src/utils/storage.test.ts`
- [ ] Шаг 2.1: Добавить импорт `afterEach` в `src/components/TodoList/TodoList.test.tsx`
- [ ] Шаг 2.2: Добавить `afterEach` hook в `src/components/TodoList/TodoList.test.tsx`
- [ ] Шаг 2.3: Удалить `consoleErrorSpy.mockRestore()` из `src/components/TodoList/TodoList.test.tsx`
